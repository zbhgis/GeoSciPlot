...
header.site a.gh{position:absolute;top:0;right:0;display:inline-flex;align-items:center;gap:8px;padding:8px 16px;border:1px solid var(--line2);border-radius:999px;background:var(--card);font-family:ui-monospace,SFMono-Regular,Menlo,Consolas,monospace;font-size:12px;color:var(--dim);transition:color .16s,border-color .16s,transform .16s}
header.site a.gh:hover{color:var(--accent);border-color:var(--accent);transform:translateY(-1px)}
header.site a.gh svg{width:17px;height:17px;flex:none}
@media (max-width:760px){header.site a.gh{padding:6px 12px;font-size:11px}}
